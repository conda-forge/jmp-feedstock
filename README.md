...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jmp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14382&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jmp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jmp` can be installed with:

```
conda install jmp
```

It is possible to list all of the versions of `jmp` available on your platform with:
